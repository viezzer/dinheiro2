...
function IncomeAndExpenseDisplay({expense, income}: IncomeAndExpenseDisplayProps) {
    return(
        <div className="bg-card text-black flex flex-col sm:flex-row justify-evenly items-center rounded-lg py-2  w-3/4 sm:w-2/3">
            <div className="w-full border-b border-1 border-black sm:border-r sm:border-b-0 p-2">
